...
[![npm version](https://img.shields.io/npm/v/%40apollo%2Fclient-ai-apps)](https://img.shields.io/npm/v/%40apollo%2Fclient-ai-apps) [![Join the community](https://img.shields.io/discourse/status?label=Join%20the%20community&server=https%3A%2F%2Fcommunity.apollographql.com)](https://community.apollographql.com)
...
| **Getting Started Guide**       | MCP Apps documentation                        | [Read Docs →](https://www.apollographql.com/docs/apollo-mcp-server/mcp-apps?utm_source=github&utm_medium=apollographql_apollo-client-ai-apps&utm_campaign=readme)                                |
...
| **API Reference**               | Complete API documentation                    | [Browse API →](https://www.apollographql.com/docs/react/api/apollo-client?utm_source=github&utm_medium=apollographql_apollo-client-ai-apps&utm_campaign=readme)                                  |
...
- [**Apollo Client MCP Apps Integration**](https://www.apollographql.com/docs/apollo-mcp-server/mcp-apps?utm_source=github&utm_medium=apollographql_apollo-client-ai-apps&utm_campaign=readme) \- Type-safe apps with GraphQL-powered on-device caching ([React](https://www.apollographql.com/docs/react?utm_medium=github&utm_source=apollographql_apollo-client-ai-apps&utm_campaign=readme), [iOS](https://www.apollographql.com/docs/ios?utm_medium=github&utm_source=apollographql_apollo-client-ai-apps&utm_campaign=readme), [Kotlin](https://www.apollographql.com/docs/kotlin?utm_medium=github&utm_source=apollographql_apollo-client&utm_campaign=readme))
